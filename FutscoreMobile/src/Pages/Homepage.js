...
const games = [
  {
    ...
    awayTeam: {
      ...
      statistics: {chutes: 19, chutesAGol: 7, posseDeBola: "62%", passes: 533, precisaoDePasse: "84%", faltas: 13, cartoesAmarelos: 2, cartoesVermelhos: 0, impedimentos: 1, escanteios: 4},      
